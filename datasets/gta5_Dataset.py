...
class GTA5_Dataset(City_Dataset):
    def __init__(self,
                 args,
                 data_root_path='/home/visionlab/lixinhui/dataset/GTA5',
                 list_path='/home/visionlab/lixinhui/SAN-SAW-main/datasets/GTA5/list',
                 split='train',
                 base_size=769,
                 crop_size=769,
                 training=True):
        ...
        print('self.list_path', self.list_path)
...
class GTA5_xuanran_Dataset(City_Dataset):
    def __init__(self,
        ...
        if self.xuanran is not None:
            ...
            for id in self.items:
                ...
                for i in range(len(self.xuanran)):
                    image_path = os.path.join(self.xuanran[i], "{0:05d}.png".format(id))
        ...
        self.label_lst = []
        for id in self.items:
            image_path = os.path.join(self.gt_filepath, "{0:05d}.png".format(id))
