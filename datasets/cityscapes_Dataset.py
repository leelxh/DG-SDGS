...
class City_Dataset(data.Dataset):
    def __init__(self,
                 args,
                 data_root_path=os.path.abspath('/home/visionlab/lixinhui/dataset/cityscapes'),
                 list_path=os.path.abspath('/home/visionlab/lixinhui/SAN-SAW-main/datasets/city_list'),
                 split='train',
                 base_size=769,
                 crop_size=769,
                 training=True,
...
class City_DataLoader():
    def __init__(self, args, training=True):
        ...
        data_set = City_Dataset(args,
                                data_root_path='/home/visionlab/lixinhui/dataset/cityscapes',
                                list_path='/home/visionlab/lixinhui/SAN-SAW-main/datasets/city_list',
                                split=args.split,
        ...
        val_set_bdds = City_Dataset(args,
                               data_root_path='../../dataset/BDD100k/images/val',
